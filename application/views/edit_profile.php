		<div id="edit_profile" class="float_left">	
			...
			<form id="edit_profile_info_form" action="/ci/user/process_edit_profile_info" method="post">
		...
		<div id="edit_profile_pw" class="float_right">
			...
			<form id="edit_profile_pw_form" action="/ci/user/process_edit_profile_pw" method="post">
		...
		<div id="description" class="clear">
			...
			<form id="edit_profile_description_form" action="/ci/user/process_edit_profile_description" method="post">
			  <fieldset class="border">
